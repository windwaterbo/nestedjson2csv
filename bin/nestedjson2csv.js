...
var program = require('commander'),
    fs = require('fs'),
    os = require('os'),
    nestedjson2csv = require('../lib/nestedjson2csv'),
    path = require('path'),
...
if(!program.fields && !program.fieldList) throw new Error('Please specify fields with -f or a list of fields with -l. See nestedjson2csv --help');
...
getFields(function(err, fields) {
  ...
  getInput(function(err, input){
    ...
    nestedjson2csv(opts, function(err, csv) {
